...
<body>
    ...
    <div class="main--content">
        ...
        <form action="usr-pw-admin.php" method="post">
            <table>
                <tr>
    ...
    if (isset($_POST['ganti-pw'])) {
        ...
        if ($new_password_2 == $new_password_1) {
            $ganti_pw=mysqli_query($conn, "UPDATE administrators SET password = '$new_password_1' WHERE role = 2");
    ...
    if (isset($_POST['ganti-usr'])) {
        ...
        $ganti_pw=mysqli_query($conn, "UPDATE administrators SET username = '$new_username' WHERE role = 2");
            echo "
            <script>
